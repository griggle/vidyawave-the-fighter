...
HitAnimation::HitAnimation (std::vector<std::string> atlas, std::vector<std::vector<SDL_Rect>> hitboxes,
                           std::vector<std::vector<SDL_Rect>> hurtboxes, int fps)
    : Animation (atlas, fps), hitboxes (hitboxes), hurtboxes (hurtboxes)
{
}
