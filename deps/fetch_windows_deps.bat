...
set sdl2_mixer_dl_link=http://libsdl.org/projects/SDL_mixer/release/SDL2_mixer-devel-%sdl2_mixer_version%-VC.zip
...
powershell.exe "curl %sdl2_mixer_dl_link% -o SDL2_temp.zip; Expand-Archive SDL2_temp.zip; Move-Item SDL2_temp/* ./; Remove-Item SDL2_temp; Move-Item SDL2_mixer-%sdl2_mixer_version% SDL2_mixer-vc; Remove-Item SDL2_temp.zip; Copy-Item cmake_configs/sdl2_mixer-config.cmake SDL2_mixer-vc/sdl2_mixer-config.cmake"